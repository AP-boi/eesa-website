...
VALUES
('Priya Sharma', 'IELTS Preparation', 'IELTS 8.0 Overall', 5, 'Prashant Sir''s patient guidance helped me overcome my speaking hesitation completely! The 1-on-1 mock interviews gave me immense confidence. I got Band 8.0 in my very first attempt and secured admission in the UK!', 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=600&auto=format&fit=crop&q=80', 'Justdial', true),
('Gurpreet Singh', 'PTE Academic', 'PTE 79+ Overall', 5, 'The PTE computer practice lab at EESA Academy is top-notch. The real exam interface practice and template strategies helped me score 84 in Speaking and 81 in Writing. Highly recommended for West Delhi students!', 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=600&auto=format&fit=crop&q=80', 'Google', true),
('Sister Anjali Thomas', 'OET Healthcare', 'OET Grade B (Nurses)', 5, 'As a working nurse with night shifts, the flexible 7:00 AM batch at Dashrath Puri was a blessing! Prashant Sir corrected my medical writing daily. Passed my OET for UK NHS registration smoothly.', 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&auto=format&fit=crop&q=80', 'UrbanPro', true),
('Rahul Verma', 'Spoken English & Public Speaking', 'Conversational Fluency', 5, 'I was extremely hesitant during job interviews. The interactive group roleplays and accent neutralization modules at EESA transformed my personality. I cracked my corporate interview in Gurugram!', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&auto=format&fit=crop&q=80', 'Verified Student', true);
