    ...
    <div className="space-y-16 py-8 sm:py-12">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-3">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-950/60 p-2.5 rounded-lg border border-emerald-200 dark:border-emerald-800 text-[11px] font-semibold text-emerald-800 dark:text-emerald-300">
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-3">
            ...
            <div className="text-xs text-slate-700 dark:text-slate-300 space-y-1">
              ...
              <p className="pt-1">
                Official Email:{' '}
                <a href="mailto:info@expert-educational.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                  info@expert-educational.com
                </a>
              </p>
              <p>
                Alternate Email:{' '}
                <a href="mailto:eesaacademy22@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Map Embed (7 Cols) */}
          <div className="lg:col-span-7 bg-white dark:bg-slate-900 p-4 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl space-y-4">
          ...
          {/* Form (5 Cols) */}
          <div className="lg:col-span-5 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl">
            ...
            {submitted ? (
              <div className="bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 p-6 rounded-2xl text-center space-y-3">
                ...
                <h4 className="font-bold text-slate-900 dark:text-white text-lg">Message Sent Successfully!</h4>
                <p className="text-xs text-slate-700 dark:text-slate-300 leading-relaxed">
                ...
                <button
                  ...
                  className="bg-blue-600 text-white text-xs font-bold px-4 py-2 rounded-lg cursor-pointer"
                >
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white dark:focus:bg-slate-800 text-slate-900 dark:text-white"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-semibold outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white dark:focus:bg-slate-800 text-slate-900 dark:text-white"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-600 text-slate-900 dark:text-white"
                  >
